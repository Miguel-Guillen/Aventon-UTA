...
if ($registro > 0){
  ...
  $query2 = mysqli_query($con, "select * from tpasajeros where email='$params->email'
  and idMatricula='$params->idMatricula'");
  ...
  if ($registro2 > 0){
    ...
    mysqli_query($con, "INSERT INTO tpasajeros (nombre,celular,curp,email,password,idMatricula) 
